...
TMPL_XML_READ_WRITE(JacobianTarget)
...
TMPL_XML_READ_WRITE(EnergyLevelMap)
...
TMPL_XML_READ_WRITE(HitranRelaxationMatrixData)
...
TMPL_XML_READ_WRITE(ScatteringParticle)
TMPL_XML_READ_WRITE(ScatteringSpecies)
TMPL_XML_READ_WRITE(ScatteringHabit)
...
TMPL_XML_READ_WRITE(ArrayOfArrayOfAbsorptionLines)
...
TMPL_XML_READ_WRITE(ArrayOfJacobianTarget)
...
TMPL_XML_READ_WRITE(ArrayOfScatteringParticle)
TMPL_XML_READ_WRITE(ArrayOfScatteringSpecies)
...
TMPL_XML_READ_WRITE(ArrayOfTime)
TMPL_XML_READ_WRITE(ArrayOfArrayOfTime)
